  ...
  return (
    ...
    >
      ...
      <Stack.Group screenOptions={{ presentation: "modal" }}>
        <Stack.Screen name="Chirppage" component={Chirppage} />
        <Stack.Screen name="Replypage" component={Replypage} />
        <Stack.Screen name="Settingspage" component={Settingspage} />
        <Stack.Screen name="Verifyuserpage" component={Verifyuserpage} />
      </Stack.Group>
    </Stack.Navigator>
  );
}
