...
function Verifyuserpage(props) {
  ...
  if (canSubmit) {
    ...
    submit = <View style={styles.buttoncontainer}></View>;
  } else {
    submit = (
    ...
    <>
      <ScrollView style={styles.textcontainer}>
        ...
        <Text style={styles.text}>
          Good news, you are almost done with the sign in process!
        </Text>
        <Text style={styles.text}>
          You just need a name your firends know you by!
        </Text>
        <Text style={styles.text}>
          And a username to be your unique identifier
        </Text>
      </ScrollView>
